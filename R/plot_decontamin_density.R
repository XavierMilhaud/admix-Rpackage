...
#' sample1 <- rsimmix(n=6000, unknownComp_weight=0.5, comp.dist = list(list.comp$f1,list.comp$g1),
#'                                                    comp.param=list(list.param$f1,list.param$g1))
#' sample2 <- rsimmix(n=5500, unknownComp_weight=0.7, comp.dist = list(list.comp$f2,list.comp$g2),
