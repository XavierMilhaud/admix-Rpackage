...
plot_decontamin_density(x_val = seq(from=-1,to=6,length.out=40), decontamin_obj = res1, add_plot = FALSE)
plot_decontamin_density(x_val = seq(from=-1,to=6,length.out=40), decontamin_obj = res2, add_plot = TRUE, col = "red")
```
